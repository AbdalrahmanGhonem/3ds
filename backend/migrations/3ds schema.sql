...
CREATE TABLE `order_items` (
  ...
  `product_slug` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_image_url` text COLLATE utf8mb4_unicode_ci,
  `selected_color` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `orders` (
  ...
  `governorate` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `district` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `address` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `payment_method` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cash_on_delivery',
  ...
  `user_id` bigint unsigned DEFAULT NULL,
  `guest_token` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `payer_mobile` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_submitted_at` datetime DEFAULT NULL,
  `payment_confirmed_at` datetime DEFAULT NULL,
  `payment_rejected_at` datetime DEFAULT NULL,
  `payment_review_note` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
